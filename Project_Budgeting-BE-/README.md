...
Double-click **`run_all.bat`** inside the `Project_Budgeting-BE-` directory. This Windows batch script will launch both servers in individual command line windows automatically:
