...
export const Step3BankDetails: React.FC<Props> = ({ existingAccountNumberMasked }) => {
  ...
  return (
    <div className="space-y-8">
      <section>
        <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-4 dark:text-gray-300">Bank Information</h3>
      ...
      <section className="border-t pt-6">
        <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-4 dark:text-gray-300">Additional Bank Details (Optional)</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
