...
export const CreateProjectModal: React.FC<CreateProjectModalProps> = ({
    ...
    // Default due date to 30 days from today to avoid required validation errors
    ...
    React.useEffect(() => {
        if (isOpen) {
            ...
            if (quoteId) {
                ...
                if (quoteDueDate) {
                    setDueDate(quoteDueDate);
                } else {
                    setDueDate(defaultDueDate);
                }
            } else {
                setProjectType(hideBudgetTab ? 'internal' : 'external');
                setProjectName('');
                setDueDate(defaultDueDate);
            }
            // Reset other fields
    ...
    }, [isOpen, clientName, quoteId, quoteName, quoteDueDate, hideBudgetTab]);
