                                            ...
                                            <div className="space-y-6">
                                                {!project?.budget ? (
                                                    <div className="bg-gray-50 rounded-lg border border-gray-200 p-8 text-center">
                                                        ...
                                                        <p className="text-sm text-gray-500">No budget configuration is available for this project.</p>
                                                    </div>
                                                    ...
                                                    <div className="space-y-6">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                                            ...
                                                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 text-left">
                                                                ...
                                                                <p className="text-2xl font-bold text-gray-900">
                                                                    {parseFloat(project.budget.total_budget || project.budget.quoted_amount || '0').toLocaleString()} {project.budget.currency}
                                                                </p>
                                                                <p className="text-xs text-gray-500 mt-2">Maximum allocated budget</p>
                                                            </div>

                                                            {/* Used Hours Cost (Labor Outflow) */}
                                                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 text-left">
                                                                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Labor Outflow (Actual)</p>
                                                                <p className="text-2xl font-bold text-blue-600">
                                                                    {parseFloat(project.budget.used_budget || '0').toLocaleString()} {project.budget.currency}
                                                                </p>
                                                                <p className="text-xs text-gray-500 mt-2">Cost of logged task hours</p>
                                                            </div>

                                                            {/* Bills and Expenses (Other Outflow) */}
                                                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 text-left">
                                                                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Bills & Expenses Outflow</p>
                                                                <p className="text-2xl font-bold text-orange-600">
                                                                    {parseFloat(project.budget.bills_and_expenses || '0').toLocaleString()} {project.budget.currency}
                                                                </p>
                                                                <p className="text-xs text-gray-500 mt-2">Vendor bills and other expenses</p>
                                                            </div>
                                                            ...
                                                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 text-left">
                                                                ...
                                                                <p className="text-xs text-gray-500 mt-2">Budget headroom left</p>
                                                            </div>
                                                        </div>
                                                                ...
                                                                return (
                                                                    <div className="space-y-3">
                                                                        <div className="flex justify-between items-center text-sm font-semibold text-gray-700">
                                                                            <span>Total Outflow: {totalOutflowVal.toLocaleString()} {project.budget.currency}</span>
                                                                        ...
                                                                        <div className="flex justify-between text-xs text-gray-500">
                                                                            <span>0%</span>
                                                                            <span>Budget Cap: {totalBudgetVal.toLocaleString()} {project.budget.currency}</span>
                                                                        </div>
                                                                    </div>
                                                                );
                                                            })()}
                                                        ...
                                                        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden text-left">
                                                            <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                                                                <h4 className="text-sm font-bold text-gray-900">Financial Summary</h4>
                                                            </div>
                                                            <table className="min-w-full divide-y divide-gray-200 text-sm">
                                                                <tbody className="divide-y divide-gray-200 bg-white">
                                                                    ...
                                                                    <tr>
                                                                        <td className="px-6 py-4 font-medium text-gray-700">Use Quoted Amount</td>
                                                                        <td className="px-6 py-4 text-right text-gray-950 font-semibold">
                                                                            {project.budget.use_quoted_amounts ? 'Yes' : 'No'}
                                                                        </td>
                                                                    </tr>
                                                                    {project.budget.quoted_amount && (
                                                                        <tr>
                                                                            <td className="px-6 py-4 font-medium text-gray-700">Quoted Amount Reference</td>
                                                                            <td className="px-6 py-4 text-right text-gray-950">
                                                                                {parseFloat(project.budget.quoted_amount).toLocaleString()} {project.budget.currency}
                                                                            </td>
                                                                        </tr>
                                                                    )}
                                                                </tbody>
                                                    ...
                                                    <div className="space-y-6">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                                                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
                                                                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Allocated Hours</p>
                                                                <p className="text-2xl font-bold text-gray-900">
                                                                    {project.budget.billable_hours || 0} hrs
                                                                </p>
                                                                <p className="text-xs text-gray-500 mt-2">Total budget in hours</p>
                                                            </div>

                                                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
                                                                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Remaining Billable Hours</p>
                                                                <p className="text-2xl font-bold text-blue-600">
                                                                    {project.budget.remaining_billable_hours || '00:00:00'}
                                                                </p>
                                                                <p className="text-xs text-gray-500 mt-2">Hours headroom left</p>
                                                            </div>

                                                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
                                                                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Total Budget Hours</p>
                                                                <p className="text-2xl font-bold text-gray-900">
                                                                    {project.budget.total_hours || 0} hrs
                                                                </p>
                                                                <p className="text-xs text-gray-500 mt-2">Quoted task hours limit</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                )}
